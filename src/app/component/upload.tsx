import { UploadProps } from "../utilis/type";
...
const Upload: React.FC<UploadProps> = ({ label }) => {
    return (
        <label htmlFor="uploadFile1"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" className="w-11 mb-4 fill-gray-500" viewBox="0 0 32 32">
                <path
            ...
            <p className="text-xs font-medium text-gray-400 mt-4">PNG, JPG SVG, WEBP, and GIF are Allowed.</p>
        </label>
    )
}
