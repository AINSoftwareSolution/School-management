                ...
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto px-4 py-2">
                    ...
                    <div className={`w-full md:block md:w-auto ${isCollapsed ? 'hidden' : ''}`} id="navbar-default">
                        <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white">
                            ...
                            <li>
                                <Link href="#programs" className="block py-2 px-3 text-purple-900 font-[700] rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0">Programs</Link>
                            </li>
                            <li>
                            ...
                            <li>
                                <Link href="#contact" className="block py-2 px-3 text-purple-900 font-[700] rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0">Contact</Link>
                            </li>
                        </ul>
                    </div>
                </div>
